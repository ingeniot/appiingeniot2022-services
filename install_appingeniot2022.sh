...
sudo git clone https://github.com/ingeniot/appingeniot2022-services.git
sudo mv appingeniot2022-services services
...
sudo git clone https://github.com/ingeniot/appingeniot2022-app.git
sudo mv appingeniot2022-app app
...
sudo sh -c "echo 'MONGO_DATABASE=appingeniot' >> $filename"
sudo sh -c "echo '' >> $filename"
